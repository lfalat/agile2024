...
namespace AGILE2024_BE.Migrations
{
    ...
    [Migration("20250405174157_Sprint6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.Adaptation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.AdaptationDoc", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("DescriptionDocs")
                        .IsRequired()
                        .HasColumnType("longtext");
                    ...
                    b.ToTable("AdaptationDocs");
                });

            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.AdaptationState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AdaptationStates");
                });

            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.AdaptationTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AdaptationTasks");
                });

            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.CourseEmployee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.CourseState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.CoursesDoc", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("CoursesDocs");
                });

            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.CoursesType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.Adaptation", b =>
                {
                    b.HasOne("AGILE2024_BE.Models.EmployeeCard", "CreatedEmployee")
                        .WithMany()
                    ...
                    b.HasOne("AGILE2024_BE.Models.Entity.Adaptation.AdaptationState", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Adaptation.AdaptationDoc", b =>
                {
                    b.HasOne("AGILE2024_BE.Models.Entity.Adaptation.Adaptation", "Adaptation")
                        .WithMany()
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.Course", b =>
                {
                    ...
                    b.HasOne("AGILE2024_BE.Models.Entity.Courses.CoursesType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("AGILE2024_BE.Models.Entity.Courses.CourseEmployee", b =>
                {
                    b.HasOne("AGILE2024_BE.Models.Entity.Courses.Course", "Course")
                        .WithMany()
                    ...
                    b.HasOne("AGILE2024_BE.Models.Entity.Courses.CourseState", "State")
                        .WithMany()
                        .HasForeignKey("StateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
